...
class CFastLED {
	...
	uint32_t m_nMinMicros;		///< minimum μs between frames, used for capping frame rates.
...
public:
	...
	static CLEDController &addLeds(CLEDController *pLed, struct CRGB *data, int nLedsOrOffset, int nLedsIfOffset = 1);
